...
<div class="relative">
    <nav class="dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 fixed top-0 w-full bg-white z-50 hidden sm:block">
     ...
     {{-- Bottom bar --}}
    <nav class="flex sm:hidden fixed bottom-0 w-full bg-white/80 dark:bg-slate-900/80 backdrop-blur-lg border-t border-slate-200 dark:border-slate-800 z-[9999] pb-safe">
        <div class="flex justify-around items-center w-full h-16 px-2">
            ...
            @guest
                {{-- Beranda --}}
                <a href="{{ route('beranda') }}" class="flex-1 flex flex-col items-center justify-center transition-all duration-300 {{ request()->routeIs('beranda') ? $activeClass : $inactiveClass }}">
                    <i class="bi {{ request()->routeIs('beranda') ? 'bi-house-fill' : 'bi-house' }} text-xl"></i>
                    <span class="text-[10px] font-medium mt-1">Beranda</span>
                ...
                <a href="{{ route('login') }}" class="flex-1 flex flex-col items-center justify-center transition-all duration-300">
                    <i class="bi bi-box-arrow-in-right text-2xl"></i>
                    <span class="text-[10px] font-medium mt-1">Login</span>
                </a>
            @endguest
        </div>
    </nav>

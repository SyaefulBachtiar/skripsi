<div>
    <div class="flex items-center gap-4 p-2">
        <div class="w-16 h-16 rounded-full overflow-hidden border border-gray-100 shadow-sm">
            <img 
        ...
        <div class="flex flex-col">
            <div class="flex items-center gap-1 group cursor-pointer">
                <h1 class="text-xl font-bold text-gray-800">{{ $data_technician->user->name }}</h1>
                <i class="bi bi-chevron-right text-gray-400 group-hover:text-indigo-600 transition-colors"></i>
            </div>
            
            <div class="flex items-center gap-3 mt-1 text-sm text-gray-500">
                <div class="flex items-center gap-1">
                    <span class="font-semibold text-gray-800 text-base">4.8</span>
                    <i class="bi bi-star-fill text-yellow-400"></i>
                </div>
                <span class="text-gray-300">|</span>
                <div class="flex items-center gap-1">
                    <span class="font-semibold text-gray-800 text-base">10</span>

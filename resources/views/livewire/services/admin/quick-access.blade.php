...
>
    ...
    >
        {{-- Semua User --}}
        <a href="#" class="group flex flex-col items-center justify-center gap-2 p-3 sm:p-4 bg-white dark:bg-slate-800 rounded-xl border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">

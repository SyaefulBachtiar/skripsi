...
new #[Layout('layouts.guest')] class extends Component
{
    ...
    public function register(): void
    {
        ...
        $this->redirect(route('login.technician', absolute: false), navigate: true);
...
<div class="w-full">
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-slate-600 dark:text-slate-400">
            Sudah punya akun? 
            <a href="{{ route('login.technician') }}" wire:navigate class="font-semibold text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 transition-colors">
                Masuk di sini
            </a>
        </p>
    </div>
    ...
    <form wire:submit="register" class="space-y-5">
        ...
        <!-- Social Login -->
        <div class="mb-6">
            <a href="{{ route('auth.google', ['role' => 'technician']) }}" type="button" class="flex items-center w-full justify-center gap-2 px-4 py-2.5 border border-slate-300 dark:border-slate-600 rounded-xl text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all duration-200 group">
